...
export default function InvoicesPage() {
  ...
  const getRowColor = (status?: string) => {
    ...
    if (status === "Paid") return "bg-green-50 border-l-4 border-green-500";
    ...
    if (status === "Cancelled") return "bg-gray-50 border-l-4 border-gray-400";
  ...
  return (
    <div className="p-8">
      <div className="flex justify-between mb-6">
        ...
        <AddInvoiceDialog onAdded={fetchInvoices} />
      </div>
      ...
      <Table>
        ...
        <TableBody>
          ...
          {invoices.map((invoice) => (
            <TableRow key={invoice.id} className={getRowColor(invoice.status)}>
